...
export const Create = () => {
  ...
  const uploadImage = async () => {
    ...
    data.append("upload_preset", "blogit-aniket");
    data.append("cloud_name","dxmdnbvfc");
    console.log(data);
    ...
    try {
      ...
      const response = await fetch(
        `https://api.cloudinary.com/v1_1/dxmdnbvfc/image/upload`,
        {
          method: "POST",
          body: data,
        }
    ...
    if (!imageLink) {
      ...
      try {
        const response = await axios.post(
          `${VITE_BACKEND_URL}/api/v1/blog/create`,
          {
            title: title,
            content: content,
            imageUrl: imageLink,
